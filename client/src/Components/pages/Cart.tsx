...
function Cart() {
    ...
    const {items, totalPrice, totalCount} = useTypesSelector(({cart}) => cart)
    const {clearCart, removeCartItem, removeLocalItem, addLocalItem} = useCartActions()
    ...
    const onAddLocalItem = (id:string) => {
        addLocalItem(id)
    }

    const onRemoveLocalItem = (id:string) => {
        removeLocalItem(id)
    }
